...
<CardGrid>
	<Card 
		...
		icon="setting">
		Everything you need to know to understand the animated effects environment on FoundryVTT. Includes installation and update guides for our modules as well as information about our Patreon.
	</Card>
	<Card 
