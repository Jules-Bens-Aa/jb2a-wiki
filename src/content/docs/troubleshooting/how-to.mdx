    ...
    <TabItem label="Automated Animations">
        ...
        <Steps>
            ...
            1. Have you <strong>targeted</strong> a token?
                ...
                <p align="center"><Image src={tokenTarget} alt="Token Contextual Menu to Target" style="width: 50%;"/></p>
            ...
            4. Is the Diagnostic all green?
                ...
                <Steps>
                    ...
                    1. Open the Autorecognition Menu.
                        ...
                        <p align="center">
                            <Image src={aaDiagnosticsButton} alt="Diagnostics button on Automated Animations' Autorec Menu" style="width: 25%;"/>
                        </p>

                    2. Click "Diagnostics" button to open the Diagnostics Window. It should look something lile this.

                        <p align="center">
                            <Image src={aaDiagnostics} alt="Diagnostics window - Automated Animations" style="width: 20%;"/>
                        </p>
            ...
            6. Is the item/spell/feature disabled in its AA configuration menu?
                ...
                <Steps>
                    ...
                    2. Check if the animation is enabled and activate "Customize Item" if you want only this item to have its own specific animation. 
            ...
            7. Have you rolled for attack or damage? Check in AA's settings.
                ...
                <p align="center">
                    <Image src={aaDamageRoll} alt="Settings for Automated Animations" style="width: 20%;"/>
                </p>
