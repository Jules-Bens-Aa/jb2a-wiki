...
These steps are designed to suit a wide range of problems. Some steps may be unnecessary in your case, but these are solid guidelines to follow whenever you're trying to solve a problem you've encountered.
