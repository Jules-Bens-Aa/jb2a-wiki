...
import PIXI-Fix from '/src/assets/img/PIXI-Fix.png'
...
This problem occurs, as far as we have figured out, because of a browser or graphic card update. Toggle the "PIXI FIx" option in the Sequencer module settings, meaning if it's on, turn it off and if it's off, turn it on.

<p align="center"><Image src={PIXI-Fix} alt="How to lock our Patreon Module" style="width: 25%;"/></p>
...
<LinkButton href="https://github.com/MrVauxs/pf2e-jb2a-macros/wiki" icon="github" variant="custom">PF2e-Animations wiki</LinkButton>
...
Any issue with this module that we know how to resolve will be added here. If it's not, please read the documentation on the wiki and then reach us on our Discord server, under the #pf2e-discussion channel.
<LinkButton href="https://github.com/MrVauxs/pf2e-graphics/wiki" icon="github" variant="custom">PF2e-Animations wiki</LinkButton>
<LinkButton href="https://discord.gg/gmd8MAPX4m" icon="discord" variant="secondary">Join our Discord Server</LinkButton>
