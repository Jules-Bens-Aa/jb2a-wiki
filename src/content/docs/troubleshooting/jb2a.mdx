...
#### Only new stuff
  ...
  If your problem persists, please contact us on our [Discord server](https://discord.gg/gmd8MAPX4m) on the `jb2a-troubleshooting` channel.
...
#### Missing channels
Check the "Browse Channels" at the top of the cahnnels list to join other channels.
