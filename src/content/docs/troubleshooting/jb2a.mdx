...
#### Can't find animation
  ...
  If you can't find our animations via the tile browser or the Sequencer Database Viewer, it may be because the installation wasn't done correctly,the FoundryVTT server wasn't restarted since the install, or our module isn't enabled in the world. 
  If your problem persists, please report your issue so we can try and help you.
...
#### No Patreon assets, only free
  ...
  Any tile or token you have setup using file paths may break though. It's an easy fix and we can provide a macro in our [Discord server](https://discord.gg/gmd8MAPX4m) to fix all of them with a batch macro if you have too many of them.
