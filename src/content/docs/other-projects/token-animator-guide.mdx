...
import thumbnailArtwork from '/src/assets/img/token-animator/Thumbnails/Guide_Tab.png'
import thumbnailPngs from '/src/assets/img/token-animator/Thumbnails/Guide_Tab2.png'
import thumbnailBorders from '/src/assets/img/token-animator/Thumbnails/Guide_Tab3.png'
import thumbnailShorts from '/src/assets/img/token-animator/Thumbnails/Guide_Tab4.png'
import thumbnailRings from '/src/assets/img/token-animator/Thumbnails/Guide_Tab5.png'
import thumbnailParticles from '/src/assets/img/token-animator/Thumbnails/Guide_Tab6.png'
import thumbnailStages from '/src/assets/img/token-animator/Thumbnails/Guide_Tab7.png'
import thumbnailStageAnims from '/src/assets/img/token-animator/Thumbnails/Guide_Tab8.png'
import thumbnailRender from '/src/assets/img/token-animator/Thumbnails/Guide_Tab9.png'
...
<p><Image src={winexplorer} alt="Landing Page of FoundryVTT" style="width: 35%;"/></p>
...
<Tabs syncKey="builder-tabs">
    ...
    <iframe align="center" poster= {thumbnailArtwork} width="auto" height="auto" src="https://www.youtube.com/embed/QEPgOwiZhLk?si=P-8S670fcXN0DDVl" title="YouTube video player" frameborder="0" allow="accelerometer;    autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
      {/* <p align="center"><Image src={thumbnailArtwork} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <iframe width="560" height="500" src="https://www.youtube.com/embed/QEPgOwiZhLk?si=girJu9uBuFbJs61F" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;    encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      ...
      {/* <p align="center"><Image src={thumbnailPngs} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <TabItem label="Borders">
      ...
      {/* <p align="center"><Image src={thumbnailBorders} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <TabItem label="Shorts">
      ...
      {/* <p align="center"><Image src={thumbnailShorts} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <TabItem label="Rings">
      ...
      {/* <p align="center"><Image src={thumbnailRings} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
      Speaks by itself, this effects are in a ring shape and will loop seamlessly.
    </TabItem>

    <TabItem label="Particles">
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/ZlosuZ9-4mw?si=EI4Ni4Kxg3mBlSxB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      {/* <p align="center"><Image src={thumbnailParticles} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <TabItem label="Stages">
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/N_tjmc0MM8Q?si=ZAGU3QysOBjZZCqg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      {/* <p align="center"><Image src={thumbnailStages} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
    ...
    <TabItem label="S-Anim">
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/N14T2DNJxpI?si=nvjJUmr1xKG4mx_7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      {/* <p align="center"><Image src={thumbnailStageAnims} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
...
<Tabs syncKey="utility-tabs">
    ...
    <TabItem label="Render">
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/jgStLe0D56M?si=Vv2E1uTYCGjFAFWE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      {/* <p align="center"><Image src={thumbnailRender} alt="Landing Page of FoundryVTT" style="width: 50%;"/></p> */}
