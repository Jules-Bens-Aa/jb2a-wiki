...
<Tabs syncKey="panels">
    ...
    <TabItem label="Preview">
      ...
      Video of the preview panel in use.
    ...
    <TabItem label="Shader">
      ...
      Video of the shader panel in use.
...
This is the end of this guide. If you have questions, don't forget to check out the FAQ at the end of this guide. And if you don't find your answer, please join our Discord Server and I'll be happy to assist you. I hope this tool isn't to complicated and this guide provides enough information to help you to create awesome animated tokens !
...
Follow these instructions shown in the video.
...
All the content is registered under the Creative Commons License Attribution-NonCommercial CC BY-NC-SA. You can click here to know more about this.
