...
<Steps>
    ...
    4. Click on this button, in the Token Tools on the left-hand side toolbar to open the Sequencer Database Viewer.
            ...
            <Image src={seqPlayIcon} alt="play icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" /> Preview the animation

            <Image src={seqFilepathIcon} alt="filepath icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" /> Copy the full Filepath to the animation

            <Image src={seqDatapathIcon} alt="datapath icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" /> Copy the datapath to the animation(s)
