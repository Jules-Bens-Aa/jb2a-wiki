...
import guideAaCustomField from '/src/assets/img/guide-aa-custom-field.png'
...
Since the dropdown menus don't include all of our assets, there's a handy Custom Field in each Auto-Rec entry so you can copy and paste any datapath. To search for an animation and copy its datapath, you can use the Sequencer Database Viewer, from the Sequencer module.

<Steps>

    1. Click on this button, in the Token Tools on the left-hand side toolbar.

        <p align="center"><Image src={seqDatabaseViewer} alt="Sequencer Database Viewer" style="width: 50%;"/></p>
    
    2. You can now browse through all our animations, search for a specific one, preview it and copy the filepath or database path, also called datapath . We recommend using the database path for more flexibility, and added intelligent behaviours from the Sequencer module. Click on the little datapath icon to copy it in your clipboard.
    ...
    3. You can then paste it directly in the Custom Field in the auto-rec entry.

        <p align="center"><Image src={guideAaCustomField} alt="Auto-Rec Custom Field" style="width: 50%;"/></p>

    4. Alternatively, you can as easily use our <a href="https://library.jb2a.com/">Asset Library</a> online for the same results. If you click on the database path at the bottom right, it will copy it in your clipboard.

        <p align="center"><Image src={guideAaAssetLibrary} alt="Auto-Rec Custom Field" style="width: 50%;"/></p>
    5. The little blue information button in all auto-rec entries is really handy to figure out what all the settings mean.
