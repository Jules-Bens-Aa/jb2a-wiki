...
<Steps>
    ...
    2. You can now browse through all our animations, search for a specific one, preview it <Image src={seqPlayIcon} alt="datapath icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" /> and copy the filepath <Image src={seqFilepathIcon} alt="datapath icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" /> or database path <Image src={seqDatapathIcon} alt="datapath icon" style="display: inline; width: 20px; background-color: white; border-radius: 0.2em; padding: 0.3em;" />. We recommend using the database path for more flexibility, and added intelligent behaviours from the Sequencer module. Click on the little datapath icon to copy it in your clipboard.        
    ...
    4. Alternatively, you can as easily use our Asset Library online for the same results. If you click on the database path at the bottom right, it will copy it in your clipboard.
