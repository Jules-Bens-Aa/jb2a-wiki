...
Short for Automated-Animations
...
Basically, it's a data path that offers more functionality and is easier to use in code to create an effect.
...
Macros are pre-written commands that you can send to FoundryVTT to do powerful things. With our content, macros are mainly used to create effects. 
