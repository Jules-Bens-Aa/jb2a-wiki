...
Before explaining the whole process, from installation to how to trigger an effect by clicking on a character sheet, there are a few things you need to know to better understand how JB2A fits into the Foundry VTT environment.
...
<Aside>
It is important to understand that adding animations and automating their use on Foundry VTT will inevitably require extra time to set up your sessions.
</Aside>
