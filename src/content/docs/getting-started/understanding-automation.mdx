    ...
    <TabItem label="D&D5e-Animations">
        **Made by Vauxs, helped by Sisimshow, Joost and more…**
        ...
        <LinkCard
          ...
          href="jb2a-wiki/src/content/docs/external-resources/community-links#dd5e-animations"
        />
    ...
    <TabItem label="PF2e-Animations">
        **Made by Vauxs**
        ...
        <LinkCard
          ...
          href="/jb2a-wiki/src/content/docs/external-resources/community-links#pf2e-animations"
        />
