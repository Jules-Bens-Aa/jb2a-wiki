...
import forgeFreeModule from '/src/assets/img/theforge-bazaar-freemodule.png'
import forgePatreonModule from '/src/assets/img/theforge-bazaar-patreonmodule.png'
...
<Tabs syncKey="hostingMethod">
  ...
  <TabItem label="Self-Hosting">
    <Steps>
      1. You must have an account and [subscribe to any tier](https://www.patreon.com/c/jb2a/membership) on our patreon. They all have access to the same module. To find out more about how our Patreon works, click here.
