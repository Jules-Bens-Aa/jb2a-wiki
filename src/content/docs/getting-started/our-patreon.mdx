...
Transparency is key for us to build a trust relationship with you. It's only fair that we need to create stuff for you to support us!
...
As long as you don't uninstall our premium module from The Forge, you should be able to continue to use our content although you won't be able update our module to its latest version anymore.
</Aside>
