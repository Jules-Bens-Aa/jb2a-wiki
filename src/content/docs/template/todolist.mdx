...
- [x] Find a place and create a how to contribute step by step for users who wants to modify the content of the wiki.
- [ ] Finish the Trigger your first animated effects on FoundryVTT
- [ ] Add Console clear images and tabs for other browsers in [Console](/jb2a-wiki/getting-started/jb2a-fvtt#console)
...
### Visual Communication
- [ ] Banner for the Master Post: [Image size recommended in a Patreon post is 1500x900](https://support.patreon.com/hc/en-us/articles/360038982432-How-to-size-images-on-Patreon)
