...
draft: false
---
import MyBadge from '/src/components/MyBadge.astro';

## Adding Functionality

- [ ] Install [Webcore](https://webcoreui.dev/docs/astro) for Astro.
- [ ] <MyBadge text="Failed" variant="danger" />[shadcn](https://ui.shadcn.com/docs/components/table) might be a more suitable solution.
